...
function createSucursal(res){
	...
	res.forEach(element => {
		...
		label.innerHTML = '<input style="opacity: 0;width:20px;height: 20px;position: absolute;left: 22px; cursor: pointer;" type="radio" name="empleados"><span class="inputfalso" style="border-radius: 50%;display: inline-block;height: 20px;position: absolute;left: 22px;width: 21px;z-index: -1;background-color: #ccc"></span><label style="color:#7f8581;margin-left:20px;font-size:12px;">&nbsp;'+sucursal.nombre+'</label>';
