...
<body>
   <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="inicio.php">
            <img alt="Logo" src="img/logo1.jpg" width="70" />
        </a>
    </div>
        ...
        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="kt-aside__brand-logo">
                    <a href="index.html">
                        <img alt="Logo" src="img/logo2.jpg" width="150" />
                    </a>
                </div>
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item " aria-haspopup="true"><a href="sucursales.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-architecture-and-city"></i><span class="kt-menu__link-text">Sucursales</span></a></li><br>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="empleados.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-users"></i><span class="kt-menu__link-text">Empleados</span></a></li><br>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="usuarios.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-network"></i><span class="kt-menu__link-text">Usuarios</span></a></li><br>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="clientes.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-customer"></i><span class="kt-menu__link-text">Clientes</span></a></li><br>
                        <li class="kt-menu__item " aria-haspopup="true"><a href="servicios.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-medical"></i><span class="kt-menu__link-text">Servicios</span></a></li><br>
                       <li class="kt-menu__item " aria-haspopup="true"><a href="promociones.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-tag"></i><span class="kt-menu__link-text">Promociones</span></a></li>
                    </ul>
                </div>
            </div>
