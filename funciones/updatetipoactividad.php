...
$query="UPDATE tipo_actividad SET nombre_tipo_actividad = '$nombre', estatus = '$addestatus', confirmar = '$addconfirmar', sincronizar_tipo_actividad = '$addsincronizar' WHERE id_tipo_actividad = '$id_tipo_actividad'";
