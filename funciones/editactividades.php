...
$query = "UPDATE actividades SET nombre_actividad = '$nombre_actividad', fecha_hora_inicio = '$fecha_inicio', fecha_hora_termino = '$fecha_final', id_tipo_actividad = '$idtipoactividad', id_cliente = '$id_cliente', id_empleado = '$id_empleado', id_usuario = '$id_usuario' WHERE id_actividad = '$id_actividad'";
